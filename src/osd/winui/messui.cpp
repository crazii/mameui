...
static TCHAR mess_column_names_locale[][LOCALE_BUFFER_SIZE] =
{
	TEXT("Filename"),
};
...
{
	mess_column_names_locale[0],
};

// columns for software list
static TCHAR softlist_column_names_locale[][LOCALE_BUFFER_SIZE] =
{
	TEXT("Name"),
	TEXT("List"),
	TEXT("Description"),
...
static LPCTSTR softlist_column_names[] =
{
	softlist_column_names_locale[0],
	softlist_column_names_locale[1],
	softlist_column_names_locale[2],
	softlist_column_names_locale[3],
	softlist_column_names_locale[4],
	softlist_column_names_locale[5],
};
...
static TCHAR st_tabs[][LOCALE_BUFFER_SIZE] =
{
	{TEXT("picker\0SW Files")},
	{TEXT("devview\0Media View")},
	{TEXT("softlist\0SW Items")},
};

void Messui_InitLocalization(HINSTANCE hInstance)
{
	::LoadString(hInstance, IDS_MESSUI_SWFILES, st_tabs[0], LOCALE_BUFFER_SIZE);
	::LoadString(hInstance, IDS_MESSUI_MEDIAVIEW, st_tabs[1], LOCALE_BUFFER_SIZE);
	::LoadString(hInstance, IDS_MESSUI_SWITEMS, st_tabs[2], LOCALE_BUFFER_SIZE);
	
	::LoadString(hInstance, IDS_MESSUI_FILENAME, mess_column_names_locale[0], LOCALE_BUFFER_SIZE);
	
	::LoadString(hInstance, IDS_MESSUI_SLC_NAME, softlist_column_names_locale[0], LOCALE_BUFFER_SIZE);
	::LoadString(hInstance, IDS_MESSUI_SLC_LIST, softlist_column_names_locale[1], LOCALE_BUFFER_SIZE);
	::LoadString(hInstance, IDS_MESSUI_SLC_DESC, softlist_column_names_locale[2], LOCALE_BUFFER_SIZE);
	::LoadString(hInstance, IDS_MESSUI_SLC_YEAR, softlist_column_names_locale[3], LOCALE_BUFFER_SIZE);
	::LoadString(hInstance, IDS_MESSUI_SLC_PUBLSHER, softlist_column_names_locale[4], LOCALE_BUFFER_SIZE);
	::LoadString(hInstance, IDS_MESSUI_SLC_USAGE, softlist_column_names_locale[5], LOCALE_BUFFER_SIZE);
}

static LPCTSTR SoftwareTabView_GetTabLongName(int tab)
{
	return st_tabs[tab] + _tcslen(st_tabs[tab]) + 1;
}
